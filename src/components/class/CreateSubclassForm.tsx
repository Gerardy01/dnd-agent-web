...
// hooks
import useSubclassForm from "@/hooks/class/useSubclassForm";
...
// interfaces
import type { CreateClassSubDTO } from "@/models/classInterfaces";
...
export default function CreateSubclassForm({ onCancel, onSubmit, spells }: SubclassFormProps) {
    const {
        subclassForm,
        submitLoad,
        isSpellcaster,
        ...
        handleApplyPreset,
        presets,
    } = useSubclassForm(onCancel, onSubmit, spells);

    const { t } = useTranslation();
    const spellPreparationType = Form.useWatch('spellPreparationType', subclassForm);
    ...
    return (
        <Form
            ...
            onFinish={submitSubclassForm}
            initialValues={{
                preparedLvlBonus: 0,
                preparedModBonus: false
            }}
