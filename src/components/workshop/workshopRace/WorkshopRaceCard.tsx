...
// hooks
import useWorkshopRaceCard from "@/hooks/workshop/workshopRace/useWorkshopRaceCard";

// interfaces
import type { WorkshopRaceReturn } from "@/models/raceInterfaces";

interface Props {
    item: WorkshopRaceReturn;
    uponDelete: (workshopRaceId: number) => void;
    onClick?: () => void;
    onEditClick?: () => void;
}
...
export default function WorkshopRaceCard({ item, uponDelete, onClick, onEditClick }: Props) {
    ...
    const {
        ...
        handleHover,
        handleMenuHover,
    } = useWorkshopRaceCard(item.workshopRaceId, uponDelete, onEditClick);
