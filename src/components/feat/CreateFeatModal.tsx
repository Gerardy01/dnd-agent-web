...
// hooks
import useCreateFeat from "@/hooks/feat/useCreateFeat";
...
interface Props {
    open: boolean;
    onClose: () => void;
    onSubmit: (data: CreateFeatDTO) => Promise<void>;
}

const { Title, Text } = Typography;


export default function CreateFeatModal({ open, onClose, onSubmit }: Props) {
    ...
    const {
        ...
        submitCreateFeat,
        handleCloseModal,
    } = useCreateFeat(onClose, onSubmit);
    ...
    return (
        ...
        >
            ...
            <div style={styles.header}>
                <div>
                    <Title level={2} style={{ margin: '0px' }}>{t('feats.createFeatTitle')}</Title>
                    <Text style={{ fontSize: '1rem' }}>{t('feats.createFeatDescription')}</Text>
                </div>
