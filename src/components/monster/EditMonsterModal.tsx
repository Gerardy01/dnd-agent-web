...
// hooks
import useEditMonster from "@/hooks/monster/useEditMonster";
...
export default function EditMonsterModal({ open, onClose, onSubmit, getData }: Props) {
    ...
    const {
        ...
        submitEditMonster,
        handleCloseModal,
    } = useEditMonster(onClose, onSubmit, getData);
            ...
            {monster && (
                <>
                    <div style={styles.header}>
                        <div>
                            <Title level={2} style={{ margin: '0px' }}>{t('monsters.editMonsterTitle')}</Title>
                            <Text style={{ fontSize: '1rem' }}>{t('monsters.editMonsterDescription')}</Text>
                        </div>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                            ...
                            <Button
                                ...
                                type="primary"
                                onClick={() => editMonsterForm.submit()}
                                loading={submitLoad}
                            >
                                {t('monsters.editMonster')}
                            </Button>
