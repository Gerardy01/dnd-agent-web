...
// interfaces
import type { RaceWrite } from "@/models/raceInterfaces";
...
export default function CreateRaceModal({ open, onClose, onSubmit, workshopSpells }: Props) {
    ...
    const {
        ...
        hasProgression,
        setHasProgression,
    } = useCreateRace(onClose, onSubmit, workshopSpells);
    ...
    return (
        ...
        >
            <div style={styles.header}>
                <div>
                    <Title level={2} style={{ margin: '0px' }}>Create Race</Title>
                    <Text style={{ fontSize: '1rem' }}>Create a new race for your campaigns</Text>
                </div>
                        ...
                        <div style={styles.formContainer}>
                            <div style={{ ...styles.formHeader, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                <div>
                                    ...
                                    <Text type="secondary">Add unique traits granted to members of this race</Text>
                                </div>
