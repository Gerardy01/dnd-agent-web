...
// hooks
import useEditFaction from "@/hooks/faction/useEditFaction";
...
export default function EditFactionModal({ open, onClose, onSubmit, getData }: Props) {
    ...
    const {
        ...
        submitEditFaction,
        handleCloseModal,
    } = useEditFaction(onClose, onSubmit, getData);

    const { t } = useTranslation();

    const colorValue = Form.useWatch('color', editFactionForm);
            ...
            {faction ? (
                <>
                    ...
                    <div style={styles.header}>
                        <div>
                            <Title level={2} style={{ margin: '0px' }}>{t('factions.editFactionTitle')}</Title>
                            <Text style={{ fontSize: '1rem' }}>{t('factions.editFactionDescription')}</Text>
                        </div>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                            ...
                            <Button
                                ...
                                type="primary"
                                onClick={() => editFactionForm.submit()}
                                loading={submitLoad}
                            >
                                {t('factions.editFaction')}
                            </Button>
